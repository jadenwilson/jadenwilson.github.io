var init = function (window) {
    ...
    var background = opspark.makeBackground(app, ground);// called the makeBackground and stored the background to the variable background 
    view.addChild(background);// add the background as a child of view so it can be seen on screen
    ...
    window.hud = hud;// assign our variable hud to the window 
